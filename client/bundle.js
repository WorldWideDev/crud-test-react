...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserForm = __webpack_require__(97),
	    ShowUser = __webpack_require__(98);
	...
	var routes = React.createElement(
	    Router,
	    { history: hashHistory },
	    React.createElement(Route, { path: '/create', component: UserForm }),
	    React.createElement(Route, { path: '/show', component: ShowUser })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserForm = React.createClass({
	    ...
	    handleFormSubmit: function (e) {
	        ...
	        var self = this;
	        axios.post('users/create', { username: newUser }).then(function (res) {
	            if (res.data.errors) {
	                self.setState({ error: res.data.errors.username.message });
	                self.setState({
	                    hasErrors: true,
	                    errors: [React.createElement(Error, { key: 0, message: self.state.error })]
	                });
	            } else {
	    ...
	    handleChange: function (e) {
	        if (e.target.value != '') {
	            ...
	            this.setState({ errors: [React.createElement(Error, { key: 0, message: this.state.error })] });
	        }
	    },
	    render: function () {
	        var err = '';
	        return React.createElement(
	            ...
	            'Username: ',
	            React.createElement('input', { className: this.state.hasErrors ? 'user-create-inpt-errors' : 'user-create-inpt', type: 'text', onFocus: this.handleFocus, onChange: this.handleChange }),
	            React.createElement('input', { type: 'submit', value: 'Create User' }),
	            this.state.errors
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var axios = __webpack_require__(99),
	    ...
	    UserRow = __webpack_require__(121),
	    hashHistory = ReactRouter.hashHistory;
	...
	var ShowUser = React.createClass({
	    ...
	    handleUserQuery: function () {
	        axios.get('users/index').then(jsonRes => this.handleUsers(jsonRes));
	    },
	    handleUsers(res) {
	        var self = this;
	        let userList = res.data.map(function (result) {
	            return React.createElement(UserRow, { key: result._id, name: result.username, handleUserQuery: self.handleUserQuery });
	        });
	        this.setState({
	            users: userList
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserRow = React.createClass({
	    ...
	    handleDelete: function () {
	        axios.post('users/delete', { username: this.props.name }).then(function (res) {
	            hashHistory.push({ pathname: 'show' });
	        });
	    ...
	    handleEdit: function (e) {
	        if (e.keyCode === 13) {
	            axios.post('users/edit', { newUsername: e.target.value, oldUsername: this.props.name }).then(function (res) {
	                hashHistory.push({ pathname: 'show' });
	            });
	            this.props.handleUserQuery();
	            this.setState({ isEdit: false });
	    ...
	    render: function () {
	        return !this.state.isEdit ? React.createElement(
	            ...
	            React.createElement(
	                'td',
	                null,
	                React.createElement('input', { className: 'user-row-inpt', type: 'text', defaultValue: this.props.name, onKeyDown: this.handleEdit, autoFocus: true, onBlur: this.handleFocusOut })
	            ),
	            React.createElement(
	                'td',
	                null,
